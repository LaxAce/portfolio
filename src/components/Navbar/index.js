...
const navItems = (handleLink) => (
    <>
        ...
        <a href={resume} className='btn btn-resume'>Resume</a>
    </>
)
        ...
        <div className='navbar'>
            <div className="top-nav-container">
                ...
                <div className="side-nav">
                    <BiMenuAltRight className="menu-btn open-side-nav" onClick={handleModal} />
                </div>
            </div>
            <div className={active ? "side-nav-wrapper active": "side-nav-wrapper"} onClick={handleModal}>
                <div className="side-blur-effect"></div>
                <div className="side-nav-content" onClick={(e) => e.stopPropagation()}>
                    <div className="close-nav-wrapper"><AiOutlineClose className="menu-btn close-side-nav" onClick={handleModal}/></div>
                    {navItems(handleLink)}
                </div>
            </div>
        </div>
